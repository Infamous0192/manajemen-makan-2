...
Route::prefix('admin')->name('admin.')->middleware(['auth', 'role:admin'])->group(function () {
    ...
    Route::resource('bayar', Admin\BayarController::class)->parameter('bayar', 'bayar');
    Route::resource('biaya', Admin\BiayaController::class)->parameter('biaya', 'biaya');
    Route::resource('blok', Admin\BlokController::class)->parameter('blok', 'blok');
    Route::resource('daftar', Admin\DaftarController::class)->parameter('daftar', 'daftar');
    Route::resource('gaji', Admin\GajiController::class)->parameter('gaji', 'gaji');
    Route::resource('harga_makam', Admin\HargaMakamController::class)->parameter('harga_makam', 'harga_makam');
    Route::resource('jenazah', Admin\JenazahController::class)->parameter('jenazah', 'jenazah');
    Route::resource('lokasi', Admin\LokasiController::class)->parameter('lokasi', 'lokasi');
