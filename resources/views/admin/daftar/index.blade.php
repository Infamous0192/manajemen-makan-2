                                    ...
                                    <table class="table" id="table-1">
                                        ...
                                        <tbody>
                                            @foreach ($daftar as $data)
                                                <tr>
                                                    <td class="text-center">{{ $data->id_daftar }}</td>
                                                    <td>{{ $data->nama }}</td>
                                                    <td>{{ $data->no_hp }}</td>
                                                    <td>{{ $data->tanggal_meninggal }}</td>
                                                    <td>{{ $data->id_jenazah }}</td>
                                                    <td>
                                                        <a href="{{ route('admin.daftar.edit', $data->id_daftar) }}"
                                                            class="btn btn-warning">Edit</a>
                                                        <form
                                                            action="{{ route('admin.daftar.destroy', $data->id_daftar) }}"
